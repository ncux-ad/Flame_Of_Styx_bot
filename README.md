...
- ✅ **Исправленные баги** - решены проблемы с типизацией и командами
- 🔄 **Синхронизация каналов** - автоматическое определение нативных/иностранных каналов
...
#### 📺 Управление каналами
- `/channels` - Управление каналами с разделением на нативные и Foreign
- `/sync_channels` - Синхронизировать статус каналов (нативные/Foreign)
...
- `/suspicious_analyze <user_id>` - Проанализировать конкретного пользователя
- `/suspicious_remove <user_id>` - Удалить пользователя из подозрительных
- `/suspicious_reset` - Сбросить все подозрительные профили
...
- ✅ Разделение каналов на нативные и Foreign
