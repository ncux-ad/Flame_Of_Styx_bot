...
class TestConfig:
    ...
    def test_config_validation(self):
        ...
        config = Settings(
            bot_token="1234567890:ABCDEFGHIJKLMNOPQRSTUVWXYZ", admin_ids="123456789,987654321", db_path="test.db"
        )
    ...
    def test_redis_url_validation(self):
        ...
        # Valid URLs
        valid_urls = ["redis://localhost:6379/0", "rediss://localhost:6380/0", "redis://user:pass@localhost:6379/0"]
        for url in valid_urls:
            config = Settings(
                bot_token="1234567890:ABCDEFGHIJKLMNOPQRSTUVWXYZ", admin_ids="123456789", db_path="test.db", redis_url=url
            )
    ...
    def test_admin_ids_parsing(self):
        ...
        config = Settings(
            bot_token="1234567890:ABCDEFGHIJKLMNOPQRSTUVWXYZ", admin_ids="123456789,987654321,555666777", db_path="test.db"
        )
