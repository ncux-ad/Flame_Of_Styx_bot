...
from app.models.secure_models import SecureMessage, SecureUser
...
class TestSecureModels:
    ...
    def test_secure_user_model(self):
        ...
        # Valid user
        user = SecureUser(id=123456789, username="testuser", first_name="Test", last_name="User")
    ...
    def test_secure_message_model(self):
        ...
        message = SecureMessage(
            message_id=1, text="Hello world", chat_id=123456789, date=1234567890
        )
        assert message.text == "Hello world"

        # XSS in text should be sanitized
        malicious_message = SecureMessage(
            message_id=1, text='<script>alert("xss")</script>', chat_id=123456789, date=1234567890
        )
