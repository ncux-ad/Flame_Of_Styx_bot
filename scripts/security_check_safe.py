#!/usr/bin/env python3
"""
Safe security check script for AntiSpam Bot.
Безопасная версия без использования eval/exec/os.system.
"""
...
class SafeSecurityChecker:
    ...
    def run_all_checks(self) -> Dict[str, Any]:
        ...
        logger.info("🔍 Запуск безопасной проверки безопасности...")
