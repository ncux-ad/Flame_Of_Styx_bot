...
print_header() {
    echo -e "${BLUE}🌐 External Monitoring Setup${NC}"
    echo -e "${BLUE}============================${NC}"
    echo -e "${YELLOW}💡 Внешние сервисы мониторинга${NC}"
    echo ""
}
...
print_success "🎉 Внешний мониторинг настроен!"
print_info "Внешние сервисы для мониторинга:"
print_info "  • Uptime Robot: https://uptimerobot.com/"
print_info "  • Healthcheck.io: https://healthchecks.io/"
print_info "  • Pingdom: https://www.pingdom.com/"
print_info ""
print_info "URL для мониторинга:"
print_info "  • Healthcheck: http://${SERVER_IP}:8080/healthcheck.php"
print_info "  • Netdata: http://${SERVER_IP}:19999"
print_info ""
print_info "💡 Настройте внешний сервис на ваш healthcheck URL!"
