...
class HelpService:
    ...
    def _get_admin_commands_detailed(self) -> str:
        ...
        return (
            ...
            "• Статус каналов (нативные/Foreign)\n"
            ...
            "<b>/suspicious_reset</b> - Сбросить все подозрительные профили\n"
            "• Удаляет все записи из базы данных\n"
            "• Сбрасывает систему анализа\n"
            "• Используйте для очистки системы\n\n"
            "<b>/suspicious_analyze</b> - Анализ конкретного пользователя\n"
            ...
            "<b>/suspicious_remove</b> - Удалить из подозрительных\n"
            ...
            "<b>/force_unban</b> - Принудительный разбан пользователя\n"
            ...
            "<b>/find_chat</b> - Поиск ID чата по invite ссылке или username\n"
            ...
            "<b>/my_chats</b> - Список каналов где бот является администратором\n"
            ...
            "📖 <b>Инструкции:</b>\n"
            "<b>/instructions</b> - Инструкция по настройке бота\n"
            "• Пошаговая инструкция для администраторов каналов\n"
    ...
    async def get_instructions_text(self, user_id: Optional[int] = None) -> str:
        ...
        return self.get_category_help("instructions", user_id)
