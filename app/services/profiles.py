...
class ProfileService:
    ...
    async def analyze_user_profile(
        ...
        try:
            ...
            logger.error(f"Error analyzing profile for user {user.id}: {e}")
            return None
    ...
    async def _analyze_linked_chat(self, chat: Chat) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error(f"Error analyzing linked chat {chat.id}: {e}")
    ...
    async def _notify_admin_about_suspicious_profile(
        ...
        try:
            ...
            logger.error(f"Error notifying admin about suspicious profile: {e}")
    ...
    async def mark_profile_as_reviewed(
        ...
        try:
            ...
            logger.info(f"Profile {user_id} marked as reviewed by admin {admin_id}")
            return True
            
        except Exception as e:
            logger.error(f"Error marking profile as reviewed: {e}")
            return False
