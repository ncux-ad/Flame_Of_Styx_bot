...
class AdminService:
    ...
    async def get_welcome_message(self) -> str:
        ...
        return (
            "🤖 <b>Flame of Styx AntiSpam Bot v2.0.0</b>\n\n"
            "Доступные команды:\n"
            "/status - статистика бота и мониторинг\n"
            "/spam_analysis - анализ спама и статистика\n"
            ...
            "/help - помощь\n\n"
            "🔒 <b>Безопасность:</b> Включена защита ПД и логирование\n"
            "📊 <b>Мониторинг:</b> Glances + Healthcheck доступны"
        )
