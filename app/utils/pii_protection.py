...
class PIIProtector:
    ...
    def create_secure_log_entry(self, 
                              message: str, 
...
class SecureLogger:
    ...
    def _setup_log_paths(self):
        ...
        for dir_path in [self.general_logs_dir, self.encrypted_logs_dir, 
                        self.security_logs_dir, self.reports_dir]:
    ...
    def log_message(self, 
        ...
        log_entry = self.pii_protector.create_secure_log_entry(
            message, user_id, chat_id, additional_data
        )
    ...
    def get_spam_analysis_data(self, 
