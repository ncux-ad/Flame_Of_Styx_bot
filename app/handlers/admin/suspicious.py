...
async def handle_suspicious_reset_command(
    ...
    try:
        ...
        logger.info(
            f"Reset {sanitize_for_logging(str(deleted_count))} suspicious profiles for {sanitize_for_logging(str(message.from_user.id))}"
        )
...
async def handle_recalculate_suspicious_command(
    ...
    try:
        ...
        logger.info(
            f"Recalculated {sanitize_for_logging(str(recalculated_count))} suspicious profiles for {sanitize_for_logging(str(message.from_user.id))}"
        )
...
async def handle_cleanup_duplicates_command(
    ...
    try:
        ...
        logger.info(
            f"Cleaned up {sanitize_for_logging(str(cleaned_count))} duplicate profiles for {sanitize_for_logging(str(message.from_user.id))}"
        )
